...
val nowPlayingMovie = listOf(
    ...
    MovieModel(
        ...
        assetImage = R.drawable.black_panther,
        type = "Action",
        duration = "1h 46m",
        rating = "N/A",
    ...
    MovieModel(
        ...
        assetImage = R.drawable.doctor_strange,
        type = "Action",
        duration = "2h 11m",
        rating = "N/A",
    ...
    MovieModel(
        ...
        assetImage = R.drawable.captain_marvel,
        type = "Action",
        duration = "2h 11m",
        rating = "N/A",
        synopsis = "A Viking prince seeks justice for his father",
        isPlaying = false
    ),
    MovieModel(
        id= "7",
        title = "Avengers : End Game",
        assetImage = R.drawable.end_game,
        type = "Action",
        duration = "2h 11m",
        rating = "N/A",
        synopsis = "Residents in a lonely gulch of inland California bear witness to an uncanny, chilling discovery.",
